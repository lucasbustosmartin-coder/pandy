...
- **Terceros e intermediario en patas:** mismos criterios de signo **pagador − / cobrador +** donde aplique; patas con intermediario delegan en la ruta de sync ya prevista para multicontraparte por transacción.
...
- Además de **pagador/cobrador editables** en UI, hace falta **persistir** en cada transacción **quién** es cada extremo cuando no basta el rol genérico (IDs de cliente/intermediario).
