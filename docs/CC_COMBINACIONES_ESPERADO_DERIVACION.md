...
**Criterios clave:**
- **Cliente – Comisión Pandy (+5k):** solo cuando el par cliente está ejecutado (Tx1 y Tx2 en E). Si Tx2 = P → no se incluye 5k → saldo/detalle sin comisión.
...
**Par cliente:** Tx1 E, Tx2 P → contrapartida no ejecutada → **Comisión Pandy no se incluye** (regla por par ejecutado). Cliente: solo Tx1 -200k → saldo **-200.000**, detalle **[-200.000]**. **Int:** Tx3 y Tx4 ambas P → no se escribe nada → saldo **0**, detalle **[]**.

- **Saldo cliente:** **-200.000** | **Detalle cliente:** **[-200.000]**
- **Saldo int:** **0** | **Detalle int:** **[]**
...
Par cliente sigue pendiente (Tx2 P) → sin 5k. Cliente: -200.000, detalle [-200.000]. Int: Tx3 (P, true) -200k, Tx4 (E) +197k, Com. Int +3k → saldo -197.000.
...
Mismo criterio cliente (Tx2 P → sin 5k). Int: Tx3 (E) -200k, Tx4 (P, true) no suma según reglas; Com. Int entra → saldo -197.000.
...
Cliente: -200.000, [-200.000]. Int: par cerrado → -200k + 197k + 3k = 0, detalle [-200.000, 197.000, 3.000].
...
| E,P,P,P     | -200.000      | 0         | [-200.000]                   | []                         |
| E,P,P,E     | -200.000      | -197.000  | [-200.000]                   | [-200.000, 3.000]          |
| E,P,E,P     | -200.000      | -197.000  | [-200.000]                   | [-200.000, 3.000]          |
| E,P,E,E     | -200.000      | 0         | [-200.000]                   | [-200.000, 197.000, 3.000] |
...
- **Cliente sin comisión 5k (solo -200k en detalle):** cuando Tx2 = P (E,P,P,P; E,P,P,E; E,P,E,P; E,P,E,E).
