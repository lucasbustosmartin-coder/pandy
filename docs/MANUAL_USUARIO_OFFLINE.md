...
- **Anular orden:** vas a ver un resumen de cómo cambia el saldo de cuenta corriente (y caja, si aplica) **antes** de confirmar. Al confirmar, la orden y sus transacciones quedan anuladas, los movimientos derivados no suman al saldo, y queda registrado en Auditoría quién lo hizo y qué filas se tocaron. Los movimientos **manuales** de cuenta corriente no se anulan con la orden.  
