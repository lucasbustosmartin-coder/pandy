...
- **Panel de inicio:** tarjetas de **caja** (movimientos cerrados), **G/P operativa** (por período: día / semana / mes / total; el **Total** suma **seis bolsas** alineadas al servidor: caja manual, caja por órdenes sin comisión del acuerdo en caja, CC clientes e intermediarios sin líneas de comisión del acuerdo en concepto, y dos bolsas de **comisión del acuerdo** empresa/intermediario desde `comisiones_orden` por fecha de orden más comisiones solo en CC si no hay fila en esa tabla — así no se cuenta dos veces el mismo importe), bloque **Pendientes**.  
