...
- **Vista Cuenta corriente:** resumen y movimientos según la copia y filtros que ya tenías (incluye la búsqueda por nombre en **Saldos** si la usaste). **Con red**, al abrir esa vista por primera vez en la sesión puede verse un momento el estado de carga (spinner) mientras la app alinea movimientos con las órdenes; recién después se muestran saldos y tablas, para que no aparezcan cifras intermedias incorrectas.  
