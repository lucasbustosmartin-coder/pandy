...
- **Cierre orden en dos monedas (ARS-USD, USD-ARS):** Dos movimientos de cierre en CC cliente **solo cuando ambas** patas (ingreso Cliente→Pandy y egreso Pandy→Cliente) están ejecutadas: -monto recibido (monR) y +monto entregado (monE). Si solo una está ejecutada, no hay cierre y el saldo muestra solo la moneda de la transacción ejecutada.
