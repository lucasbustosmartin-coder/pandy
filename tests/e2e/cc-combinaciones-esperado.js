...
const COMBINACIONES_ESPERADO = [
  ...
  // 5. E,P,P,P — Tx1 E = ingreso cheque
  { id: 'E,P,P,P', tx1: 'E', tx2: 'P', tx3: 'P', tx4: 'P', saldoClienteARS: -200000, saldoIntARS: 0, detalleCliente: [-200000], detalleInt: [], saldoCajaEfectivoARS: 0, saldoCajaChequeARS: 200000 },
  // 6. E,P,P,E
  { id: 'E,P,P,E', tx1: 'E', tx2: 'P', tx3: 'P', tx4: 'E', saldoClienteARS: -200000, saldoIntARS: -197000, detalleCliente: [-200000], detalleInt: [-200000, 3000], saldoCajaEfectivoARS: 197000, saldoCajaChequeARS: 200000 },
  // 7. E,P,E,P — Tx1 +200k cheque, Tx3 -200k cheque (Pandy entrega) → saldo cheque 0
  { id: 'E,P,E,P', tx1: 'E', tx2: 'P', tx3: 'E', tx4: 'P', saldoClienteARS: -200000, saldoIntARS: -197000, detalleCliente: [-200000], detalleInt: [-200000, 3000], saldoCajaEfectivoARS: 0, saldoCajaChequeARS: 0 },
  // 8. E,P,E,E
  { id: 'E,P,E,E', tx1: 'E', tx2: 'P', tx3: 'E', tx4: 'E', saldoClienteARS: -200000, saldoIntARS: 0, detalleCliente: [-200000], detalleInt: [-200000, 197000, 3000], saldoCajaEfectivoARS: 197000, saldoCajaChequeARS: 0 },
