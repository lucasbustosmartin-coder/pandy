...
-- Incluye abm_tipos_operacion (menú Tipos de operación) y RLS tipos_operacion con ese permiso.
...
DROP POLICY IF EXISTS "ordenes_insert_perm" ON public.ordenes;
DROP POLICY IF EXISTS "ordenes_update_perm" ON public.ordenes;
...
DROP POLICY IF EXISTS "ordenes_delete_perm" ON public.ordenes;
...
DROP POLICY IF EXISTS "instrumentacion_insert_perm" ON public.instrumentacion;
DROP POLICY IF EXISTS "instrumentacion_update_perm" ON public.instrumentacion;
...
DROP POLICY IF EXISTS "comisiones_orden_insert_perm" ON public.comisiones_orden;
DROP POLICY IF EXISTS "comisiones_orden_update_perm" ON public.comisiones_orden;
DROP POLICY IF EXISTS "comisiones_orden_delete_perm" ON public.comisiones_orden;
...
DROP POLICY IF EXISTS "transacciones_insert_perm" ON public.transacciones;
DROP POLICY IF EXISTS "transacciones_update_perm" ON public.transacciones;
DROP POLICY IF EXISTS "transacciones_delete_perm" ON public.transacciones;
...
-- 11) RLS tipos_operacion y modos_pago (catálogo: ABM tipos, o ingresar/editar orden para uso en flujo)
...
DROP POLICY IF EXISTS "modos_pago_insert_perm" ON public.modos_pago;
DROP POLICY IF EXISTS "modos_pago_update_perm" ON public.modos_pago;
DROP POLICY IF EXISTS "modos_pago_delete_perm" ON public.modos_pago;
...
DROP POLICY IF EXISTS "instrumentacion_delete_perm" ON public.instrumentacion;
